...
import { CSSInlayHints } from "./services/cssInlayHints.js";
...
export interface LanguageService {
	...
	doInlayHints?(document: TextDocument, stylesheet: Stylesheet): InlayHint[];
...
function createFacade(
	...
	return {
		...
		doInlayHints: inlayHints?.doInlayHints.bind(inlayHints),
		format,
...
export function getCSSLanguageService(
	...
	return createFacade(
		...
		cssDataManager,
		new CSSInlayHints(cssDataManager),
	);
}
